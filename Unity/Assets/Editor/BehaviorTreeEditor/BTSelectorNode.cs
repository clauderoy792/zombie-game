...
public class BTSelectorNode : BTParentNode
{
	public BTSelectorNode() : base("Selector")
	{
		Icon = Resources.Load("Icons/IcoSelector") as Texture2D;
	...
	{
		//
		aWriter.WriteStartElement("Selector");
	...
	//
	public new static BTSelectorNode Load(System.Xml.XmlNode aXmlNode)
	{
		BTSelectorNode node = new BTSelectorNode();
